...
import {postComments} from '../redux/actions/actions';
...
class Feedback extends React.Component {
  constructor(props) {
    ...
    this._pan = new Animated.Value(0 * DISTANCE);
  }
  ...
  onSubmit = async () => {
    ...
    commentsObj.rating = rating;
    await postComments(commentsObj);
  ...
  onValidate = () => {
    ...
    if (
      ...
      Reactotron.log(email, comments, rating);
